...
export class MarkdownFormatter {
  ...
  formatActivities(filterResult: FilterResult, timeRange: DateRange, options: FormatOptions = {}): string {
    ...
    if (activities.length > 0) {
      if (groupByProject) {
        sections.push(
          this.formatActivitiesByProject(activities, matchReasons, {
            showMatchReasons,
            showDetailedTime,
        ...
        sections.push(
          this.formatActivitiesByType(activities, matchReasons, {
            showMatchReasons,
            showDetailedTime,
            maxDescriptionLength,
          })
        ...
        sections.push(
          this.formatActivitiesList(activities, matchReasons, {
            showMatchReasons,
            showDetailedTime,
            maxDescriptionLength,
          })
